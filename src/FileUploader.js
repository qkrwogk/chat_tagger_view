...
const FileUploader = () => {
  ...
  return (
      ...
      <div className="card-body">
        ...
        <p className="card-text">메신저 대화내역 분석 결과(.json)를 파일로 업로드 하십시오.</p>
        <Fragment>
          <br /><button onClick={handleButtonClick} className="btn btn-primary" data-bs-toggle="popover" data-bs-title="파일 업로드" data-bs-content="분석 결과(.json) 업로드">파일 업로드</button>
          <input type="file"
            ref={fileInput}
